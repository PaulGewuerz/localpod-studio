/**
 * One-off: apply the 20260806000000_add_show_scriptwriter migration via raw SQL.
 ...
 * statements so it is safe to re-run. Same pattern as apply-automation-*.js.
 */
...
async function main() {
  const sqlPath = path.join(__dirname, '../prisma/migrations/20260806000000_add_show_scriptwriter/migration.sql');
