/**
 * One-off: apply the 20260612000000_add_show_automation migration via raw SQL.
...
async function main() {
  const sqlPath = path.join(__dirname, '../prisma/migrations/20260612000000_add_show_automation/migration.sql');
